...
var paper = new function (t) {
    ...
    "undefined" != typeof module && (module.exports = e), Array.isArray || (Array.isArray = function (t) {
        ...
        toString: function () {
            ...
            exports: {enumerable: !0}, extend: function ie() {
                var t = ie.base.apply(this, arguments), n = t.prototype._class;
                ...
                return e.deserialize("string" == typeof t ? JSON.parse(t) : t, function (t, i, r) {
                    var s = n && n.constructor === t ? n : e.create(t.prototype), a = s === n;
                    if (!r && 1 === i.length && s instanceof y && (!(s instanceof x) || a)) {
                        var o = i[0];
                        e.isPlainObject(o) && (o.insert = !1)
                    }
                    return t.apply(s, i), a && (n = null), s
                })
    ...
    var n = {
        attach: function (n, i) {
            ...
            if (r) {
                ...
                s = s[n] = s[n] || [], -1 == s.indexOf(i) && (s.push(i), r.install && 1 == s.length && r.install.call(this, n))
            }
        }, detach: function (n, i) {
            if ("string" != typeof n) return e.each(n, function (t, e) {
                this.detach(e, t)
            }, this), t;
            var r, s = this._eventTypes[n], a = this._handlers && this._handlers[n];
        ...
        }, on: "#attach", off: "#detach", trigger: "#fire", _installEvents: function (t) {
            var e = this._handlers, n = t ? "install" : "uninstall";
            ...
            inject: function re() {
                for (var t = 0, n = arguments.length; n > t; t++) {
                    var i = arguments[t], r = i._events;
                    if (r) {
                        var s = {};
                        e.each(r, function (t, n) {
                            var r = "string" == typeof t, a = r ? t : n, o = e.capitalize(a),
                                h = a.substring(2).toLowerCase();
                            s[h] = r ? {} : t, a = "_" + a, i["get" + o] = function () {
                                return this[a]
                            }, i["set" + o] = function (t) {
                                var e = this[a];
        ...
        _class: "PaperScope", initialize: function se(t) {
        ...
        }, version: "0.9.18", getView: function () {
            return this.project && this.project.getView()
        }, getPaper: function () {
            return this
        }, execute: function (t) {
            paper.PaperScript.execute(t, this), Z.updateFocus()
        }, install: function (t) {
            var n = this;
            ...
            return {
                _scopes: {}, _id: 0, get: function (t) {
                    return t && t.getAttribute && (t = t.getAttribute("id")), this._scopes[t] || null
    ...
    var o = new function () {
        ...
        var n = [[.5773502691896257], [0, .7745966692414834], [.33998104358485626, .8611363115940526], [0, .5384693101056831, .906179845938664], [.2386191860831969, .6612093864662645, .932469514203152], [0, .4058451513773972, .7415311855993945, .9491079123427585], [.1834346424956498, .525532409916329, .7966664774136267, .9602898564975363], [0, .3242534234038089, .6133714327005904, .8360311073266358, .9681602395076261], [.14887433898163122, .4333953941292472, .6794095682990244, .8650633666889845, .9739065285171717], [0, .26954315595234496, .5190961292068118, .7301520055740494, .8870625997680953, .978228658146057], [.1252334085114689, .3678314989981802, .5873179542866175, .7699026741943047, .9041172563704749, .9815606342467192], [0, .2304583159551348, .44849275103644687, .6423493394403402, .8015780907333099, .9175983992229779, .9841830547185881], [.10805494870734367, .31911236892788974, .5152486363581541, .6872929048116855, .827201315069765, .9284348836635735, .9862838086968123], [0, .20119409399743451, .3941513470775634, .5709721726085388, .7244177313601701, .8482065834104272, .937273392400706, .9879925180204854], [.09501250983763744, .2816035507792589, .45801677765722737, .6178762444026438, .755404408355003, .8656312023878318, .9445750230732326, .9894009349916499]],
            ...
            r = Math.abs, s = Math.sqrt, a = Math.pow, h = Math.cos, u = Math.PI, l = 1e-5, c = 1e-11;
        return {
            TOLERANCE: l, EPSILON: c, KAPPA: 4 * (s(2) - 1) / 3, isZero: function (t) {
                return r(t) <= c
                ...
                var l = n / (2 * t), d = i / t, f = l * l;
                if (d - c > f) return 0;
                var _ = f > d ? s(f - d) : 0, g = u(_ - l);
                return _ > 0 && (g = u(-_ - l)), g
            }, solveCubic: function (t, n, i, l, d, f, _) {
                if (r(t) < c) return o.solveQuadratic(n, i, l, d, f, _);
                n /= t, i /= t, l /= t;
                var g = e(d, f, _), p = n * n, v = (p - 3 * i) / 9, m = (2 * p * n - 9 * n * i + 27 * l) / 54,
                    y = v * v * v, w = m * m - y;
                if (n /= 3, r(w) < c) {
                    if (r(m) < c) return g(-n);
                    var x = s(v), b = m > 0 ? 1 : -1;
                ...
                if (0 > w) {
                    var x = s(v), C = Math.acos(m / (x * x * x)) / 3, S = -2 * x, P = 2 * u / 3;
        ...
        _class: "Rectangle", _readIndex: !0, beans: !0, initialize: function (n, i, r, s) {
            ...
            var t = f.read(arguments), e = Math.max(this.x, t.x), n = Math.max(this.y, t.y),
                i = Math.min(this.x + this.width, t.x + t.width), r = Math.min(this.y + this.height, t.y + t.height);
            return new f(e, n, i - e, r - n)
        }, unite: function () {
            var t = f.read(arguments), e = Math.min(this.x, t.x), n = Math.min(this.y, t.y),
                i = Math.max(this.x + this.width, t.x + t.width), r = Math.max(this.y + this.height, t.y + t.height);
            return new f(e, n, i - e, r - n)
        }, include: function () {
            var t = h.read(arguments), e = Math.min(this.x, t.x), n = Math.min(this.y, t.y),
        ...
        return e.each([["Top", "Left"], ["Top", "Right"], ["Bottom", "Left"], ["Bottom", "Right"], ["Left", "Center"], ["Top", "Center"], ["Right", "Center"], ["Bottom", "Center"]], function (t, e) {
            var n = t.join(""), i = /^[RL]/.test(n);
            e >= 4 && (t[1] += i ? "Y" : "X");
            var r = t[i ? 0 : 1], s = t[i ? 1 : 0], a = "get" + r, o = "get" + s, l = "set" + r, c = "set" + s,
                d = "get" + n, f = "set" + n;
            this[d] = function (t) {
                var e = t ? h : u;
        ...
        _class: "Matrix", initialize: function ae(t) {
            ...
            t *= Math.PI / 180;
            var e = h.read(arguments, 1), n = e.x, i = e.y, r = Math.cos(t), s = Math.sin(t), a = n - n * r + i * s,
                o = i - n * s - i * r, u = this._a, l = this._b, c = this._c, d = this._d;
            ...
            var t = h.read(arguments), e = h.read(arguments, 0, {readNull: !0}), n = Math.PI / 180,
                i = new h(Math.tan(t.x * n), Math.tan(t.y * n));
            return this.shear(i, e)
        }, concatenate: function (t) {
            var e = this._a, n = this._b, i = this._c, r = this._d;
            return this._a = t._a * e + t._c * n, this._b = t._b * e + t._d * n, this._c = t._a * i + t._c * r, this._d = t._b * i + t._d * r, this._tx += t._tx * e + t._ty * n, this._ty += t._tx * i + t._ty * r, this._changed(), this
        }, preConcatenate: function (t) {
            var e = this._a, n = this._b, i = this._c, r = this._d, s = this._tx, a = this._ty;
            return this._a = t._a * e + t._b * i, this._b = t._a * n + t._b * r, this._c = t._c * e + t._d * i, this._d = t._c * n + t._d * r, this._tx = t._a * s + t._b * a + t._tx, this._ty = t._c * s + t._d * a + t._ty, this._changed(), this
        }, isIdentity: function () {
            ...
            for (var s = e, a = i, o = s + 2 * r; o > s;) {
                var h = t[s++], u = t[s++];
                n[a++] = h * this._a + u * this._b + this._tx, n[a++] = h * this._c + u * this._d + this._ty
            }
            return n
        ...
        _class: "Project", _list: "projects", _reference: "project", initialize: function (t) {
            s.call(this, !0), this.layers = [], this.symbols = [], this._currentStyle = new F(null, null, this), this.activeLayer = new x, this._view = Z.create(this, t || Q.getCanvas(1, 1)), this._selectedItems = {}, this._selectedItemCount = 0, this._updateVersion = 0
            ...
            return t instanceof x ? (e.splice(this.layers, [t]), this.activeLayer || (this.activeLayer = t)) : t instanceof y ? (this.activeLayer || this.addChild(new x(y.NO_INSERT))).addChild(t) : t = null, t
            ...
            if (t.restore(), this._selectedItemCount > 0) {
                ...
                for (var o in this._selectedItems) {
                    var u = this._selectedItems[o], l = u._globalMatrix, c = this._scope.settings.handleSize, d = c / 2;
        ...
        _initialize: function (t, e) {
            var n = t && t.internal === !0, i = this._matrix = new g, r = paper.project;
            return n || (this._id = y._id = (y._id || 0) + 1), this._applyMatrix = this._canApplyMatrix && paper.settings.applyMatrix, e && i.translate(e), i._owner = this, this._style = new F(r._currentStyle, this, r), this._project || (n || t && t.insert === !1 ? this._setProject(r) : (r.activeLayer || new x).addChild(this)), t && t !== y.NO_INSERT ? this._set(t, {insert: !0}) : !0
        },
        ...
        set: function (t) {
            return t && this._set(t, {insert: !0}), this
        },
        getId: function () {
            return this._id
        },
        ...
        setName: function (e, n) {
            ...
            if (e && this._parent) {
                for (var i = this._parent._children, r = this._parent._namedChildren, s = e, a = 1; n && i[e];) e = s + " " + a++;
                (r[e] = r[e] || []).push(this), i[e] = this
            }
        ...
        beans: !0, _locked: !1, _visible: !0, _blendMode: "normal", _opacity: 1, _guide: !1, isSelected: function () {
            ...
            if (!e && this._selectChildren) for (var n = 0, i = this._children.length; i > n; n++) this._children[n].setSelected(t);
        ...
        this[n] = function (e) {
            var i = this._boundsGetter, s = !r && ("string" == typeof i ? i : i && i[n]) || n,
            ...
            _clearBoundsCache: function (e) {
                if (e._boundsCache) {
                    for (var n = 0, i = e._boundsCache.list, r = i.length; r > n; n++) {
                        var s = i[n];
                        s._bounds = s._position = t, s !== e && s._boundsCache && y._clearBoundsCache(s)
                    }
                    e._boundsCache = t
                }
            }
        ...
        beans: !0, _decompose: function () {
            ...
            var e = this._globalMatrix, n = this._project._updateVersion, i = this.getView()._matrix;
            return e && e._updateVersion !== n && (e = null), e || (e = this._globalMatrix = this._matrix.clone(), e.preConcatenate(this._parent ? this._parent.getGlobalMatrix(!0) : i), e._updateVersion = n), t ? e : i.inverted().concatenate(e)
        ...
        getProject: function () {
            ...
            var n = this.getStrokeBounds(), i = (t || this.getView().getResolution()) / 72, r = n.getTopLeft().floor(),
                s = n.getBottomRight().ceil(), a = new c(s.subtract(r)), o = Q.getCanvas(a.multiply(i)),
                h = o.getContext("2d"), u = (new g).scale(i).translate(r.negate());
            h.save(), u.applyToContext(h), this.draw(h, new e({transforms: [u]})), h.restore();
            ...
            function r(i, r) {
                var s = p["get" + r]();
                return n.subtract(s).divide(l).length <= 1 ? new P(i, g, {name: e.hyphenate(r), point: s}) : t
            }
            ...
            var s = this._matrix, a = i._totalMatrix, o = this.getView(),
            ...
            return !f && _ && (f = this._hitTest(n, i)), f && f.point && (f.point = s.transform(f.point)), i._totalMatrix = a, f
        ...
        matches: function (n) {
            ...
            _getItems: function ce(t, e, n) {
                for (var i = n && [], r = 0, s = t && t.length; s > r; r++) {
                    ...
                    if (n) i.push.apply(i, o); else if (o) return o
                }
                return n ? i : null
            }
        }
        ...
        importJSON: function (t) {
            ...
            var t = this._parent._children, e = this._parent._namedChildren, n = this._name, i = e[n],
                r = i ? i.indexOf(this) : -1;
            -1 != r && (t[n] == this && delete t[n], i.splice(r, 1), i.length ? t[n] = i[i.length - 1] : delete e[n])
        ...
        transform: function (t, e) {
            ...
            var n = this._matrix, i = (e || this._applyMatrix) && (!n.isIdentity() || t);
            if (!t && !i) return this;
            if (t && n.preConcatenate(t), i = i && this._transformContent(n)) {
                var r = this._pivot, s = this._style, a = s.getFillColor(!0), o = s.getStrokeColor(!0);
                r && r.transform(n), a && a.transform(n), o && o.transform(n), n.reset(!0)
            }
            var h = this._bounds, u = this._position;
            this._changed(9);
            ...
            if (l && !l.shearing && 0 === l.rotation % 90) {
                ...
                var f = this._boundsGetter, d = h[f && f.getBounds || f || "getBounds"];
            ...
            if (this._visible && 0 !== this._opacity) {
                var n = this._updateVersion = this._project._updateVersion, i = e.trackTransforms, r = e.transforms,
                    s = this._matrix, a = r[r.length - 1], o = a.clone().concatenate(s);
                if (o.isInvertible()) {
                    i && (r.push(this._globalMatrix = o), o._updateVersion = n);
                    var h, u, l, d = this._blendMode, f = this._opacity, _ = "normal" === d, g = te.nativeModes[d],
                        p = _ && 1 === f || e.clip || (g || _ && 1 > f) && this._canComposite();
                    if (!p) {
                        var v = this.getStrokeBounds(a);
                        if (!v.width || !v.height) return;
                        l = e.offset, u = e.offset = v.getTopLeft().floor(), h = t, t = Q.getContext(v.getSize().ceil().add(new c(1, 1)), e.pixelRatio)
                    }
                    t.save(), p ? (t.globalAlpha = f, g && (t.globalCompositeOperation = d)) : t.translate(-u.x, -u.y), (p ? s : o).applyToContext(t), !p && e.clipItem && e.clipItem.draw(t, e.extend({clip: !0})), this._draw(t, e), t.restore(), i && r.pop(), e.clip && !e.dontFinish && t.clip(), p || (te.process(d, t, h, f, u.subtract(l).multiply(e.pixelRatio)), Q.release(t), e.offset = l)
                }
            }
        ...
        _draw: function (t, e) {
            var n = this._style, i = n.hasFill(), r = n.hasStroke(), s = e.dontFinish || e.clip;
            if (i || r || s) {
                var a = this._radius, o = this._type;
                if (e.dontStart || t.beginPath(), "circle" === o) t.arc(0, 0, a, 0, 2 * Math.PI, !0); else {
                    var h = a.width, u = a.height, l = .5522847498307936;
                    if ("ellipse" === o) {
                        var c = h * l, d = u * l;
                        t.moveTo(-h, 0), t.bezierCurveTo(-h, -d, -c, -u, 0, -u), t.bezierCurveTo(c, -u, h, -d, h, 0), t.bezierCurveTo(h, d, c, u, 0, u), t.bezierCurveTo(-c, u, -h, d, -h, 0)
                    } else {
                        var f = this._size, _ = f.width, g = f.height;
                        if (0 === h && 0 === u) t.rect(-_ / 2, -g / 2, _, g); else {
                            l = 1 - l;
                            var p = _ / 2, v = g / 2, c = h * l, d = u * l;
                            t.moveTo(-p, -v + u), t.bezierCurveTo(-p, -v + d, -p + c, -v, -p + h, -v), t.lineTo(p - h, -v), t.bezierCurveTo(p - c, -v, p, -v + d, p, -v + u), t.lineTo(p, v - u), t.bezierCurveTo(p, v - d, p - c, v, p - h, v), t.lineTo(-p + h, v), t.bezierCurveTo(-p + c, v, -p, v - d, -p, v - u)
                        }
                    }
                }
                t.closePath()
        ...
        function t(t, e, n) {
            ...
            if (!i.isZero()) for (var r = t._size.divide(2), s = 0; 4 > s; s++) {
                var a = new h(1 & s ? 1 : -1, s > 1 ? 1 : -1), o = a.multiply(r), u = o.subtract(a.multiply(i)),
                    l = new f(o, u);
        ...
        statics: new function () {
            ...
            return {
                Circle: function () {
                    ...
                    var e = b._readEllipse(arguments), n = e.radius;
        ...
        clone: function (t) {
            var e = new C(y.NO_INSERT), n = this._image, i = this._canvas;
        ...
        getPpi: function () {
            var t = this._matrix, e = new h(0, 0).transform(t), n = new h(1, 0).transform(t).subtract(e),
        ...
        setImage: function (t) {
            this._canvas && Q.release(this._canvas), t.getContext ? (this._image = null, this._canvas = t) : (this._image = t, this._canvas = null), this._size = new c(t.naturalWidth || t.width, t.naturalHeight || t.height), this._context = null, this._changed(521)
        },
        getCanvas: function () {
            if (!this._canvas) {
        ...
        setSource: function (t) {
            ...
            var n, i = this;
            n = document.getElementById(t) || new Image, n.naturalWidth && n.naturalHeight ? setTimeout(e, 0) : (q.add(n, {load: e}), n.src || (n.src = t)), this.setImage(n)
        },
        getElement: function () {
            return this._canvas || this._image
        },
        getSubCanvas: function (t) {
            var t = f.read(arguments), e = Q.getContext(t.getSize());
            return e.drawImage(this.getCanvas(), t.x, t.y, t.width, t.height, 0, 0, t.width, t.height), e.canvas
        },
        getSubRaster: function (t) {
            var t = f.read(arguments), e = new C(y.NO_INSERT);
        ...
        getAverageColor: function (t) {
            ...
            var r = 32, s = Math.min(n.width, r), a = Math.min(n.height, r), o = C._sampleContext;
            o ? o.clearRect(0, 0, r + 1, r + 1) : o = C._sampleContext = Q.getContext(new c(r)), o.save();
        ...
        setPixel: function () {
            var t = h.read(arguments), e = D.read(arguments), n = e._convert("rgb"), i = e._alpha,
        ...
        _class: "Segment", beans: !0, initialize: function (e, n, i, r, s, a) {
            ...
            var e = this._path;
            if (e) {
                var n, i, r = e._curves, s = this._index;
                r && (t && t !== this._point && t !== this._handleIn || !(n = r[s - 1] || e._closed && r[r.length - 1]) || n._changed(), t && t !== this._point && t !== this._handleOut || !(i = r[s]) || i._changed()), e._changed(25)
            }
        }, getPoint: function () {
            return this._point
        }, setPoint: function () {
            ...
            var n = this._path, t = !!t, i = this._selectionState, r = i,
            ...
            return e[0] = a, e[1] = o, r && (e[h++] = r._x + a, e[h++] = r._y + o), s && (e[h++] = s._x + a, e[h++] = s._y + o), t && (t._transformCoordinates(e, 0, e, 0, h / 2), a = e[0], o = e[1], n ? (i._x = a, i._y = o, h = 2, r && (r._x = e[h++] - a, r._y = e[h++] - o), s && (s._x = e[h++] - a, s._y = e[h++] - o)) : (r || (e[h++] = a, e[h++] = o), s || (e[h++] = a, e[h++] = o))), e
        }
    }), M = h.extend({
        ...
        _class: "Curve", initialize: function (t, e, n, i, r, s, a, o) {
            ...
            if (3 === h) this._path = t, this._segment1 = e, this._segment2 = n; else if (0 === h) this._segment1 = new k, this._segment2 = new k; else if (1 === h) this._segment1 = new k(t.segment1), this._segment2 = new k(t.segment2); else if (2 === h) this._segment1 = new k(t), this._segment2 = new k(e); else {
                var u, l, c, d;
            ...
            return null == this._length && (this._length = this.isLinear() ? this._segment2._point.getDistance(this._segment1._point) : z.getLength(this.getValues(), 0, 1)), this._length
        }, getArea: function () {
            ...
            var i = this._getParameter(t, e), r = 1e-5, s = null;
            if (i > r && 1 - r > i) {
                var a = z.subdivide(this.getValues(), i), o = n ? !1 : this.isLinear(), u = a[0], l = a[1];
            ...
            getValues: function (t, e, n) {
                var i = t._point, r = t._handleOut, s = e._handleIn, a = e._point,
                    o = [i._x, i._y, i._x + r._x, i._y + r._y, a._x + s._x, a._y + s._y, a._x, a._y];
                return n && n._transformCoordinates(o, 0, o, 0, 6), o
            }, evaluate: function (t, e, n) {
                var i, r, s = t[0], a = t[1], o = t[2], u = t[3], l = t[4], c = t[5], d = t[6], f = t[7], _ = 1e-5;
                if (0 === n && (_ > e || e > 1 - _)) {
                    var g = _ > e;
                    i = g ? s : d, r = g ? a : f
                } else {
                    var p = 3 * (o - s), v = 3 * (l - o) - p, m = d - s - p - v, y = 3 * (u - a), w = 3 * (c - u) - y,
                        x = f - a - y - w;
                    if (0 === n) i = ((m * e + v) * e + p) * e + s, r = ((x * e + w) * e + y) * e + a; else if (_ > e && o === s && u === a || e > 1 - _ && l === d && c === f ? (i = d - s, r = f - a) : _ > e ? (i = p, r = y) : e > 1 - _ ? (i = 3 * (d - l), r = 3 * (f - c)) : (i = (3 * m * e + 2 * v) * e + p, r = (3 * x * e + 2 * w) * e + y), 3 === n) {
                ...
                n === t && (n = .5);
                var c = 1 - n, d = c * i + n * s, f = c * r + n * a, _ = c * s + n * o, g = c * a + n * h,
                    p = c * o + n * u, v = c * h + n * l, m = c * d + n * _, y = c * f + n * g, w = c * _ + n * p,
                    x = c * g + n * v, b = c * m + n * w, C = c * y + n * x;
                return [[i, r, d, f, m, y, b, C], [b, C, w, x, p, v, u, l]]
            }, solveCubic: function (t, e, n, i, r, s) {
                var a = t[e], h = t[e + 2], u = t[e + 4], l = t[e + 6], c = 3 * (h - a), d = 3 * (u - h) - c,
                    f = l - a - c - d;
                ...
                return e > 0 && (t = z.subdivide(t, e)[1]), 1 > n && (t = z.subdivide(t, (n - e) / (1 - e))[0]), t
            }, isLinear: function (t) {
                var e = o.isZero;
                ...
                var n = t[0], i = t[1], r = t[2], s = t[3], a = t[4], o = t[5], h = t[6], u = t[7],
                    l = 3 * r - 2 * n - h, c = 3 * s - 2 * i - u, d = 3 * a - 2 * h - n, f = 3 * o - 2 * u - i;
                ...
                var c = 3 * (e - n) - t + i, d = 2 * (t + n) - 4 * e, f = e - t, _ = o.solveQuadratic(c, d, f, u),
                    g = 1e-5, p = 1 - g;
                l(i, 0);
                for (var v = 0; _ > v; v++) {
                    var m = u[v], y = 1 - m;
        ...
        this[t] = function () {
            ...
            return e || (e = this._bounds[t] = T[t]([this._segment1, this._segment2], !1, this._path.getStyle())), e.clone()
        }
        ...
        function e(t) {
            var e = t[0], n = t[1], i = t[2], r = t[3], s = t[4], a = t[5], o = t[6], h = t[7],
                u = 9 * (i - s) + 3 * (o - e), l = 6 * (e + s) - 12 * i, c = 3 * (i - e), d = 9 * (r - a) + 3 * (h - n),
                f = 6 * (n + a) - 12 * r, _ = 3 * (r - n);
            return function (t) {
        ...
        return {
            statics: !0, getLength: function (i, r, s) {
                ...
                function s(t) {
                    var e = n(r, t);
                    return f += t > r ? o.integrate(l, r, t, e) : -o.integrate(l, t, r, e), r = t, f - i
                }

                if (0 === i) return r;
                var a = i > 0, h = a ? r : 0, u = a ? 1 : r, i = Math.abs(i), l = e(t),
        ...
        function t(t, e, n, i, r, s, a, o) {
            var h = new I(n, i, r, s, a, o);
            (!e || e(h)) && t.push(h)
        }

        function e(r, s, a, o, h, u, l, c, d, f, _, g, v) {
            if (!(v > 20)) {
                var m, y, w, x = s[0], b = s[1], C = s[6], S = s[7], P = 1e-5, k = 1e-9, M = p.getSignedDistance,
                    I = M(x, b, C, S, s[2], s[3]) || 0, A = M(x, b, C, S, s[4], s[5]) || 0, T = I * A > 0 ? .75 : 4 / 9,
                    O = T * Math.min(0, I, A), L = T * Math.max(0, I, A), E = M(x, b, C, S, r[0], r[1]),
                    N = M(x, b, C, S, r[2], r[3]), j = M(x, b, C, S, r[4], r[5]), D = M(x, b, C, S, r[6], r[7]);
                if (x === C && k >= f - d && v > 3) m = (c + l) / 2, y = m, w = 0; else {
                    var B, R, F = n(E, N, j, D), V = F[0], q = F[1];
                    if (B = i(V, q, O, L), V.reverse(), q.reverse(), R = i(V, q, O, L), null == B || null == R) return !1;
                    r = z.getPart(r, B, R), w = R - B, m = c * B + l * (1 - B), y = c * R + l * (1 - R)
                }
                if (_ > .8 && w > .8) if (y - m > f - d) {
                    var Z = z.subdivide(r, .5), H = m + (y - m) / 2;
                    e(s, Z[0], o, a, h, u, d, f, m, H, w, !g, ++v), e(s, Z[1], o, a, h, u, d, f, H, y, w, !g, v)
                } else {
                    var Z = z.subdivide(s, .5), H = d + (f - d) / 2;
                    e(Z[0], r, o, a, h, u, d, H, m, y, w, !g, ++v), e(Z[1], r, o, a, h, u, H, f, m, y, w, !g, v)
                } else if (Math.max(f - d, y - m) < P) {
                    var U = m + (y - m) / 2, W = d + (f - d) / 2;
        ...
        function n(t, e, n, i) {
            var r, s = [0, t], a = [1 / 3, e], o = [2 / 3, n], h = [1, i], u = p.getSignedDistance,
                l = u(0, t, 1, i, 1 / 3, e), c = u(0, t, 1, i, 2 / 3, n), d = !1;
        ...
        function i(t, e, n, i) {
            for (var r, s, a, o, h, u = null, l = 0, c = e.length - 1; c > l; l++) {
                if (a = e[l][1], h = e[l + 1][1], h > a) r = null; else {
                    if (!(i >= h)) continue;
            ...
            for (var l = 0, c = t.length - 1; c > l; l++) {
                if (a = t[l][1], h = t[l + 1][1], a >= n) u = r; else if (a > h) u = null; else {
                    if (!(h >= n)) continue;
        ...
        function r(e, n, i, r, s, a) {
            ...
            for (var P = [], k = z.solveCubic(x, 1, 0, P, 0, 1), b = 0; k > b; b++) {
                var M = P[b], C = z.evaluate(x, M, 0).x;
                if (C >= 0 && y >= C) {
                    var I = z.getParameterOf(w, C, 0), A = o ? I : M, T = o ? M : I;
        ...
        return {
            statics: {
                getIntersections: function (t, n, i, a, o, h) {
                    var u = z.isLinear(t), l = z.isLinear(n);
                    return (u && l ? s : u || l ? r : e)(t, n, i, a, o, h, 0, 1, 0, 1, 0, !1, 0), o
                }
            }
        }
    }), I = e.extend({
        _class: "CurveLocation", beans: !0, initialize: function me(t, e, n, i, r, s, a) {
            this._id = me._id = (me._id || 0) + 1, this._curve = t, this._segment1 = t._segment1, this._segment2 = t._segment2, this._parameter = e, this._point = n, this._curve2 = i, this._parameter2 = r, this._point2 = s, this._distance = a
            ...
            if (!t && this._curve2) {
                ...
                this._intersection = t = new I(this._curve2, e, this._point2 || this._point, this), t._intersection = this
            }
            return t
        }, getPath: function () {
            var t = this.getCurve();
            ...
            var t = this.getParameter(), e = this.getCurve();
            ...
            for (var _ = 0; u > _; _++) {
                ...
                if (!e) {
                    ...
                    if (new p(m._point.subtract(w), w.multiply(2), !0).intersect(new p(y._point.subtract(x), x.multiply(2), !0), !1)) {
                        var b = z.subdivide(v);
                        z.getIntersections(b[0], b[1], g, g, r, function (e) {
                            return e._parameter <= f ? (e._parameter /= 2, e._parameter2 = .5 + e._parameter2 / 2, !0) : t
                        })
                    }
                }
                for (var C = e ? 0 : _ + 1; l > C; C++) z.getIntersections(v, c[C], g, a[C], r, !e && (C === _ + 1 || C === l - 1 && 0 === _) && function (t) {
                    var e = t._parameter;
                    return e >= d && f >= e
                })
            }
            for (var S = r.length - 1, _ = S; _ >= 0; _--) {
                var P = r[_], k = P._curve.getNext(), M = P._curve2.getNext();
                k && P._parameter >= f && (P._parameter = 0, P._curve = k), M && P._parameter2 >= f && (P._parameter2 = 0, P._curve2 = M)
            }
            if (S > 0) {
                r.sort(i);
        ...
        beans: !0, getPathData: function (t) {
            function e(e, n, s) {
                var a = e._point, o = n._point, h = e._handleOut, u = n._handleIn;
                if (h.isZero() && u.isZero()) s || r.push("L" + i.point(o, t)); else {
                    var l = o.subtract(a);
                    r.push("c" + i.point(h, t) + " " + i.point(l.add(u), t) + " " + i.point(l, t))
                }
            }

            var n = this._segments, i = a.instance, r = [];
            if (0 === n.length) return "";
            r.push("M" + i.point(n[0]._point));
            for (var s = 0, o = n.length - 1; o > s; s++) e(n[s], n[s + 1], !1);
            return this._closed && (e(n[n.length - 1], n[0], !0), r.push("z")), r.join("")
        }
    }, {
        isEmpty: function () {
            ...
            for (var n, i = this._segments, r = this._curves, s = t; e > s; s++) n = r[s], n._path = this, n._segment1 = i[s], n._segment2 = i[s + 1] || i[0];
            (n = r[this._closed && 0 === t ? i.length - 1 : t - 1]) && (n._segment2 = i[t] || i[0]), (n = r[e]) && (n._segment1 = i[e])
        ...
        }, clear: "#removeSegments", isFullySelected: function () {
            var t = this._segments.length;
            ...
            for (var e = new L(this), n = 0, i = e.length / Math.ceil(e.length / t), r = e.length + (this._closed ? -i : i) / 2, s = []; r >= n;) s.push(new k(e.evaluate(n, 0))), n += i;
            this.setSegments(s)
        }, reduce: function () {
            ...
            if (null !== e) {
                ...
                if (t >= 0 && t < r.length) {
                    ...
                    return this._closed ? (this.setClosed(!1), s = this) : t > 0 && (s = this._clone((new T).insertAbove(this, !0))), s._add(a, 0), this.addSegment(a[0]), s
                }
                return null
            }
            ...
            this._curves = null, this._clockwise !== t && (this._clockwise = !this._clockwise)
        }, join: function (t) {
            if (t) {
            ...
            function i(t, i, r) {
                if (!e.selected || i.isSelected()) {
                    var s = t._point;
                    if (i !== s && (i = i.add(s)), n(i, w)) return new P(r, _, {segment: t, point: i})
                }
            }
            ...
            var o, u, l, c, d, f, _ = this, g = this.getStyle(), p = this._segments, v = p.length, m = this._closed,
                y = e._tolerancePadding, w = y, x = e.stroke && g.hasStroke(), b = e.fill && g.hasFill(),
        ...
        function e(t, e, n) {
            function i(e) {
                var i = d[e];
                if (n) i._transformCoordinates(n, _, !1), r = _[0], s = _[1]; else {
                    var f = i._point;
                    r = f._x, s = f._y
                }
        ...
        return {
            _draw: function (t, n) {
                ...
                var r = n.dontStart, s = n.dontFinish || n.clip;
                r || t.beginPath();
                var a = this.getStyle(), o = a.hasFill(), h = a.hasStroke(), u = a.getDashArray(),
                ...
                if (!r && this._currentPath ? t.currentPath = this._currentPath : (o || h && !l || s) && (e(t, this), this._closed && t.closePath(), r || (this._currentPath = t.currentPath)), !s && (o || h) && (this._setStyles(t), o && (t.fill(a.getWindingRule()), t.shadowColor = "rgba(0,0,0,0)"), h)) {
                    if (l) {
                        r || t.beginPath();
                        var c, d = new L(this), f = d.length, _ = -a.getDashOffset(), g = 0;
                        for (_ %= f; _ > 0;) _ -= i(g--) + i(g--);
                        for (; f > _;) c = _ + i(g++), (_ > 0 || c > 0) && d.drawPart(t, Math.max(_, 0), Math.max(c, 0)), _ = c + i(g++)
                    }
                    t.stroke()
                }
        ...
        return {
            moveTo: function () {
                ...
                var n = h.read(arguments), i = h.read(arguments), r = e.pick(e.read(arguments), .5), s = 1 - r,
                    a = t(this)._point, o = n.subtract(a.multiply(s * s)).subtract(i.multiply(r * r)).divide(2 * r * s);
                if (o.isNaN()) throw Error("Cannot put a curve through points with parameter = " + r);
                this.quadraticCurveTo(o, i)
            }, arcTo: function () {
                var n, i, r, s, a, o = t(this), u = o._point, l = h.read(arguments), d = e.peek(arguments),
                    f = e.pick(d, !0);
                if ("boolean" == typeof f) var _ = u.add(l).divide(2),
                    n = _.add(_.subtract(u).rotate(f ? -90 : 90)); else if (e.remain(arguments) <= 2) n = l, l = h.read(arguments); else {
                    var v = c.read(arguments);
                    if (v.isZero()) return this.lineTo(l);
                    var m = e.read(arguments), f = !!e.read(arguments), y = !!e.read(arguments), _ = u.add(l).divide(2),
                        w = u.subtract(_).rotate(-m), x = w.x, b = w.y, C = Math.abs, S = 1e-11, P = C(v.width),
                        M = C(v.height), z = P * P, I = M * M, A = x * x, T = b * b, O = Math.sqrt(A / z + T / I);
                    if (O > 1 && (P *= O, M *= O, z = P * P, I = M * M), O = (z * I - z * T - I * A) / (z * T + I * A), C(O) < S && (O = 0), 0 > O) throw Error("Cannot create an arc with the given arguments");
                    i = new h(P * b / M, -M * x / P).multiply((y === f ? -1 : 1) * Math.sqrt(O)).rotate(m).add(_), a = (new g).translate(i).rotate(m).scale(P, M), s = a._inverseTransform(u), r = s.getDirectedAngle(a._inverseTransform(l)), !f && r > 0 ? r -= 360 : f && 0 > r && (r += 360)
                }
                if (n) {
                    var L = new p(u.add(n).divide(2), n.subtract(u).rotate(90), !0),
                        E = new p(n.add(l).divide(2), l.subtract(n).rotate(90), !0), N = new p(u, l), j = N.getSide(n);
                ...
                for (var B = Math.abs(r), R = B >= 360 ? 4 : Math.ceil(B / 90), F = r / R, V = F * Math.PI / 360, q = 4 / 3 * Math.sin(V) / (1 + Math.cos(V)), Z = [], H = 0; R >= H; H++) {
                    var w = l, U = null;
                    if (R > H && (U = s.rotate(90).multiply(q), a ? (w = a._transformPoint(s), U = a._transformPoint(s.add(U)).subtract(w)) : w = i.add(s)), 0 === H) o.setHandleOut(U); else {
                        var W = s.rotate(-90).multiply(q);
                        a && (W = a._transformPoint(s.add(W)).subtract(w)), Z.push(new k(w, W, U))
                    }
                    s = s.rotate(F)
                }
                this._add(Z)
        ...
        _getBounds: function (t, e) {
            ...
            isClockwise: function (t) {
                ...
                if (!e) return [t, t];
                var n = e.shiftless(), i = n.transform(new h(t, 0)), r = n.transform(new h(0, t)),
                    s = i.getAngleInRadians(), a = i.getLength(), o = r.getLength(), u = Math.sin(s), l = Math.cos(s),
                    c = Math.tan(s), d = -Math.atan(o * c / a), f = Math.atan(o / (c * a));
                return [Math.abs(a * Math.cos(d) * l - o * Math.sin(d) * u), Math.abs(o * Math.sin(f) * l + a * Math.cos(f) * u)]
            }, _addBevelJoin: function (t, e, n, i, r, s) {
                var a = t.getCurve(), o = a.getPrevious(), u = a.getPointAt(0, !0), l = o.getNormalAt(1, !0),
                    c = a.getNormalAt(0, !0), d = l.getDirectedAngle(c) < 0 ? -n : n;
                ...
                for (var a = Array(6), o = 1 / 0, h = -o, u = o, l = h, c = 0, d = t.length; d > c; c++) {
                    ...
                    for (var g = 0; 6 > g; g += 2) {
                        var p = 0 == g ? s : r, v = p ? p[0] : 0, m = p ? p[1] : 0, y = a[g], w = a[g + 1], x = y - v,
                            b = y + v, C = w - m, S = w + m;
                ...
                return r > 0 && ("miter" === n.getStrokeJoin() && (s = r * n.getMiterLimit()), "square" === n.getStrokeCap() && (s = Math.max(s, r * Math.sqrt(2)))), T.getHandleBounds(t, e, n, i, T._getPenPadding(r, i), T._getPenPadding(s, i))
            }
        }
    });
    T.inject({
        statics: new function () {
            function t(t, n, i) {
                var r = e.getNamed(i), s = new T(r && r.insert === !1 && y.NO_INSERT);
            ...
            return {
                Line: function () {
                    ...
                    var e, n = f.readNamed(arguments, "rectangle"),
                        r = c.readNamed(arguments, "radius", 0, {readNull: !0}), s = n.getBottomLeft(!0),
                        a = n.getTopLeft(!0), o = n.getTopRight(!0), h = n.getBottomRight(!0);
                    if (!r || r.isZero()) e = [new k(s), new k(a), new k(o), new k(h)]; else {
                    ...
                    var t = h.readNamed(arguments, "from"), n = h.readNamed(arguments, "through"),
                        i = h.readNamed(arguments, "to"), r = e.getNamed(arguments),
    ...
    var O = A.extend({
        ...
        _getChildHitTestOptions: function (t) {
            return "path" === t.type ? t : new e(t, {fill: !1})
        }, _draw: function (t, e) {
            ...
            if (0 !== n.length) {
                ...
                if (!e.clip) {
                    this._setStyles(t);
                    var s = this._style;
                    s.hasFill() && (t.fill(s.getWindingRule()), t.shadowColor = "rgba(0,0,0,0)"), s.hasStroke() && t.stroke()
                }
            }
        }, _drawSelected: function (t, e) {
            for (var n = this._children, i = 0, r = n.length; r > i; i++) {
                var s = n[i], a = s._matrix;
        ...
        var n = {
            moveTo: function () {
                var e = t(this), n = e && e.isEmpty() ? e : new T;
    ...
    A.inject(new function () {
        function t(t, r, s, a) {
            ...
            for (var p = 0, v = _.length; v > p; p++) {
                ...
                if (null == m._winding) {
                    ...
                    for (var x = 0; 3 > x; x++) {
                        var b = y * Math.random(), C = f.length, S = 0;
                        do if (f[S] >= b) {
                            S > 0 && (b -= f[S - 1]);
                            break
                        } while (++S < C);
                        var P = c[S].getCurve(), k = P.getPointAt(b), M = P.isHorizontal(), z = P._path;
                        z._parent instanceof O && (z = z._parent), d[x] = a && l && (z === u && l._getWinding(k, M) || z === l && !u._getWinding(k, M)) ? 0 : n(k, g, M)
                    }
                    d.sort();
            ...
            var A = new O;
            return A.addChildren(i(_, s), !0), u.remove(), l && l.remove(), A.reduce()
        }
        ...
        function n(t, e, i, r) {
            var s = 1e-5, a = t.x, o = t.y, u = 0, l = 0, c = [], d = Math.abs, f = 1 - s;
            if (i) {
                ...
                var P = e[m], w = P.values, k = P.winding, M = P.next;
                if (k && (1 === k && o >= w[1] && o <= w[7] || o >= w[7] && o <= w[1]) && 1 === z.solveCubic(w, 1, o, c, 0, M.winding || M.values[1] !== o ? f : 1)) {
                    var I = c[0], A = z.evaluate(w, I, 0).x, T = z.evaluate(w, I, 1).y;
        ...
        function i(t, e, n) {
            ...
            for (var i, r, s = [], a = .001, o = .999, h = 0, u = t.length; u > h; h++) if (i = r = t[h], !i._visited && e(i._winding)) {
                var l = new T(y.NO_INSERT), c = i._intersection, d = c && c._segment, f = !1, _ = 1;
                do {
                    ...
                    if (f && (!e(i._winding) || n) && (c = i._intersection) && (g = c._segment) && g !== r) {
                        if (n) i._visited = g._visited, i = g, _ = 1; else {
                            var m = i.getCurve();
                            _ > 0 && (m = m.getPrevious());
                            var w = m.getTangentAt(1 > _ ? a : o, !0), x = g.getCurve(), b = x.getPrevious(),
                                C = b.getTangentAt(o, !0), S = x.getTangentAt(a, !0), P = w.cross(C), M = w.cross(S);
                            if (0 !== P * M) {
                                var z = M > P ? b : x, I = e(z._segment1._winding) ? z : M > P ? x : b, A = I._segment1;
                                _ = I === b ? -1 : 1, A._visited && i._path !== A._path || !e(A._winding) ? _ = 1 : (i._visited = g._visited, i = g, A._visited && (_ = 1))
                            } else _ = 1
                        }
        ...
        _getMonoCurves: function () {
            ...
            function e(e) {
                if (0 !== z.getLength(e)) {
                    ...
                    if (z.isLinear(e)) t(e); else {
                        var a = 3 * (i - r) - n + s, h = 2 * (n + r) - 4 * i, u = i - n, l = 1e-5, c = [],
                            d = o.solveQuadratic(a, h, u, c, l, 1 - l);
                        if (0 === d) t(e); else {
                            c.sort();
                            var f = c[0], _ = z.subdivide(e, f);
                            t(_[0]), d > 1 && (f = (c[1] - f) / (1 - f), _ = z.subdivide(_[1], f), t(_[0])), t(_[1])
                        }
                    }
                }
            }
    ...
    var L = e.extend({
        initialize: function (t) {
            function e(t, e) {
                ...
                s.curves.push(n), s._computeParts(n, t._index, 0, 1)
            }

            this.curves = [], this.parts = [], this.length = 0, this.index = 0;
            for (var n, i = t._segments, r = i[0], s = this, a = 1, o = i.length; o > a; a++) n = i[a], e(r, n), r = n;
            t._closed && e(n, i[0])
        }, _computeParts: function (t, e, n, i) {
            if (i - n > 1 / 32 && !z.isFlatEnough(t, .25)) {
                var r = z.subdivide(t), s = (n + i) / 2;
                this._computeParts(r[0], e, n, s), this._computeParts(r[1], e, s, i)
            } else {
                var a = t[6] - t[0], o = t[7] - t[1], h = Math.sqrt(a * a + o * o);
                h > 1e-5 && (this.length += h, this.parts.push({offset: this.length, value: i, index: e}))
            }
        ...
        initialize: function (t, e) {
            ...
            var _ = this.points[h - 1].subtract(this.points[h]), g = this.points[h].subtract(this.points[h + 1]),
            ...
            for (var s = 1e-11, a = this.points[t], o = this.points[e], h = [[0, 0], [0, 0]], u = [0, 0], l = 0, c = e - t + 1; c > l; l++) {
                var d = n[l], f = 1 - d, _ = 3 * d * f, g = f * f * f, p = _ * f, v = _ * d, m = d * d * d,
                    y = i.normalize(p), w = r.normalize(v),
            ...
            if (Math.abs(S) > s) {
                ...
                var M = h[0][0] + h[0][1], z = h[1][0] + h[1][1];
                b = C = Math.abs(M) > s ? u[0] / M : Math.abs(z) > s ? u[1] / z : 0
            }
            var I = o.getDistance(a);
            return s *= I, (s > b || s > C) && (b = C = I / 3), [a, a.add(i.normalize(b)), o.add(r.normalize(C)), o]
            ...
            var a = this.evaluate(3, t, n), o = this.evaluate(2, i, n), h = this.evaluate(1, r, n), u = a.subtract(e),
                l = o.dot(o) + u.dot(h);
        ...
        var n, i = {
            ...
            "rgb-hsb": function (t, e, n) {
                ...
                var i = Math.max(t, e, n), r = Math.min(t, e, n), s = i - r, a = 0 === s,
                    ...
                    h = (i + r) / 2, u = a ? 0 : .5 > h ? s / (i + r) : s / (2 - i - r);
                return [o, u, h]
        ...
        return e.each(i, function (t, n) {
            r[n] = [], e.each(t, function (t, s) {
                var a = e.capitalize(t), o = /^(hue|saturation)$/.test(t),
                    u = r[n][s] = "gradient" === t ? function (t) {
                        var e = this._components[0];
                        return t = B.read(Array.isArray(t) ? t : arguments, 0, {readNull: !0}), e !== t && (e && e._removeOwner(this), t && t._addOwner(this)), t
                    } : "gradient" === n ? function () {
            ...
            _class: "Color", _readIndex: !0, initialize: function l(e) {
                ...
                if ("string" === d && e in i && (n = e, e = u[1], Array.isArray(e) ? (s = e, a = u[2]) : (this.__read && (c = 1), u = h.call(u, 1), d = typeof e)), !s) {
                    ...
                    } else if (e.constructor === B) n = "gradient", o = u; else {
    ...
    var B = e.extend({
        _class: "Gradient", initialize: function Ce(t, e) {
            this._id = Ce._id = (Ce._id || 0) + 1, t && this._set(t) && (t = e = null), this._stops || this.setStops(t || ["white", "black"]), null == this._radial && this.setRadial("string" == typeof e && "radial" === e || e || !1)
        }, _serialize: function (t, n) {
            return n.add(this, function () {
            ...
            this._stops = R.readAll(e, 0, {clone: !0});
        ...
        _class: "GradientStop", initialize: function (e, n) {
            ...
            this._color = D.read(arguments), this._color === t && (this._color = t.clone()), this._color._owner = this, this._changed()
        }, equals: function (t) {
        ...
        var n = {
            ...
            leading: 9,
            justification: 9
        }, r = {}, s = {_defaults: n, _textDefaults: new e(n, {fillColor: new D}), beans: !0};
        return e.each(n, function (n, a) {
            var o = /Color$/.test(a), h = e.capitalize(a), u = i[a], l = "set" + h, c = "get" + h;
            s[l] = function (e) {
                var n = this._owner, i = n && n._children;
                if (i && i.length > 0 && !(n instanceof O)) for (var r = 0, s = i.length; s > r; r++) i[r]._style[l](e); else {
                ...
                for (var h = 0, u = s.length; u > h; h++) {
                    var l = s[h]._style[c]();
                    if (0 === h) i = l; else if (!e.equals(i, l)) return t
                }
                return i
            }, r[c] = function () {
        ...
        _class: "Style", initialize: function (t, e, n) {
            ...
            var e = t instanceof F, n = e ? t._values : t;
        ...
        }, getFont: "#getFontFamily", setFont: "#setFontFamily", getLeading: function Se() {
            var t = Se.base.call(this), e = this.getFontSize();
        ...
        function n(t, i) {
            for (var r = [], s = 0, a = t && t.length; a > s;) {
                var o = t[s++];
                if ("string" == typeof o) o = document.createElement(o); else if (!o || !o.nodeType) continue;
                e.isPlainObject(t[s]) && V.set(o, t[s++]), Array.isArray(t[s]) && n(t[s++], o), i && i.appendChild(o), r.push(o)
            }
            return r
        }
        ...
        var r = /^(checked|value|selected|disabled)$/i, s = {text: "textContent", html: "innerHTML"},
            a = {lineHeight: 1, zoom: 1, zIndex: 1, opacity: 1};
        return {
            create: function (t, e) {
                var i = Array.isArray(t), r = n(i ? t : arguments, i ? e : null);
                ...
                if ("string" != typeof n) for (var a in n) n.hasOwnProperty(a) && this.set(e, a, n[a]); else {
                    if (!e || i === t) return e;
                ...
                if ("string" != typeof e) for (var i in e) e.hasOwnProperty(i) && this.setStyle(t, i, e[i]); else !/^-?[\d\.]+$/.test(n) || e in a || (n += "px"), t.style[e] = n;
                return t
                ...
                if ("object" == typeof e) for (var r in e) i(t, r, !0, e[r]); else i(t, e, !0, n)
            }
        }
    }, q = {
        add: function (t, e) {
    ...
    q.requestAnimationFrame = new function () {
        function t() {
            for (var e = s.length - 1; e >= 0; e--) {
                ...
                (!u || ("true" == r.getAttribute(u, "keepalive") || a) && V.isInView(u)) && (s.splice(e, 1), h())
            }
            n && (s.length ? n(t) : i = !1)
        }

        var e, n = V.getPrefixed(window, "requestAnimationFrame"), i = !1, s = [], a = !0;
        return q.add(window, {
            focus: function () {
                a = !0
            }, blur: function () {
    ...
    var Z = e.extend(n, {
        _class: "View", initialize: function Pe(t, e) {
            this._project = t, this._scope = t._scope, this._element = e;
            var n;
            this._pixelRatio || (this._pixelRatio = window.devicePixelRatio || 1), this._id = e.getAttribute("id"), null == this._id && e.setAttribute("id", this._id = "view-" + Pe._id++), q.add(e, this._viewEvents);
            var i = "none";
            if (V.setPrefixed(e.style, {
                ...
                var s = V.getOffset(e, !0), a = this;
                n = V.getViewportBounds(e).getSize().subtract(s), this._windowEvents = {
                    resize: function () {
                        V.isInvisible(e) || (s = V.getOffset(e, !0)), a.setViewSize(V.getViewportBounds(e).getSize().subtract(s))
                    }
            ...
            if (this._setViewSize(n), r.hasAttribute(e, "stats") && "undefined" != typeof Stats) {
                ...
                var h = this._stats.domElement, u = h.style, s = V.getOffset(e);
                u.position = "absolute", u.left = s.x + "px", u.top = s.y + "px", document.body.appendChild(h)
            }
            Pe._views.push(this), Pe._viewsById[this._id] = this, this._viewSize = n, (this._matrix = new g)._owner = this, this._zoom = 1, Pe._focused || (Pe._focused = this), this._frameItems = {}, this._frameItemCount = 0
        }, remove: function () {
            ...
            for (var n in this._frameItems) {
                ...
                i.item.fire("frame", new e(t, {time: i.time += t.delta, count: i.count++}))
            }
        }, _update: function () {
            ...
            t = h.read(arguments), this.scrollBy(t.subtract(this.getCenter()))
        }, getZoom: function () {
            return this._zoom
        }, setZoom: function (t) {
        ...
        var d = {
            ...
            mouseout: function (t) {
                var n = Z._focused, r = q.getRelatedTarget(t);
                !n || r && "HTML" !== r.nodeName || i(n, e(n, t), t)
            }, scroll: n
        };
        return d[o] = function (n) {
            var i = Z._focused = t(n), s = e(i, n);
        ...
        }, q.add(document, f), q.add(window, {load: n}), {
        ...
        _class: "CanvasView", initialize: function (t, e) {
            ...
            if (this._context = e.getContext("2d"), this._eventCounters = {}, this._pixelRatio = 1, "off" !== r.getAttribute(e, "hidpi")) {
                var i = window.devicePixelRatio || 1, s = V.getPrefixed(this._context, "backingStorePixelRatio") || 1;
                this._pixelRatio = i / s
            }
            Z.call(this, t, e)
        }, _setViewSize: function (t) {
            var e = t.width, n = t.height, i = this._pixelRatio, r = this._element, s = r.style;
        ...
        return {
            _handleEvent: function (t, c, d) {
                if (this._eventCounters[t]) {
                    var f = this._project,
                        _ = f.hitTest(c, {tolerance: this._scope.settings.hitTolerance, fill: !0, stroke: !0}),
                        g = _ && _.item, p = !1;
                    switch (t) {
                        case"mousedown":
        ...
        _class: "KeyEvent", initialize: function (t, e, n, i) {
            U.call(this, i), this.type = t ? "keydown" : "keyup", this.key = e, this.character = n
        }, toString: function () {
            return "{ type: '" + this.type + "', key: '" + this.key + "', character: '" + this.character + "', modifiers: " + this.getModifiers() + " }"
        }
    }), G = new function () {
        function t(t, n, r, h) {
            var u, l = r ? String.fromCharCode(r) : "", c = i[n], d = c || l.toLowerCase(), f = t ? "keydown" : "keyup",
                _ = Z._focused, g = _ && _.isVisible() && _._scope, p = g && g.tool;
            o[d] = t, c && (u = e.camelize(c)) in s && (s[u] = t), t ? a[n] = r : delete a[n], p && p.responds(f) && (paper = g, p.fire(f, new W(t, d, l, h)), _ && _.update())
        }
        ...
        var n, i = {
            ...
            s = new e({shift: !1, control: !1, option: !1, command: !1, capsLock: !1, space: !1}), a = {}, o = {};
        ...
        _class: "MouseEvent", initialize: function (t, e, n, i, r) {
            U.call(this, e), this.type = t, this.point = n, this.target = i, this.delta = r
        }, toString: function () {
            return "{ type: '" + this.type + "', point: " + this.point + ", target: " + this.target + (this.delta ? ", delta: " + this.delta : "") + ", modifiers: " + this.getModifiers() + " }"
        }
    });
    e.extend(n, {
        _class: "Palette", _events: ["onChange"], initialize: function (n, i, r) {
            var s = V.find(".palettejs-panel") || V.find("body").appendChild(V.create("div", {"class": "palettejs-panel"}));
            this._element = s.appendChild(V.create("table", {"class": "palettejs-pane"})), this._title = n, r || (r = {});
            for (var a in this.components = i) {
                var o = i[a];
                o instanceof X || (null == o.value && (o.value = r[a]), o.name = a, o = i[a] = new X(o)), this._element.appendChild(o._element), o._palette = this, r[a] === t && (r[a] = o.value)
            }
    ...
    var X = e.extend(n, {
        ...
        _types: {
            ...
            slider: {type: "range", number: !0},
            list: {
                tag: "select", setOptions: function () {
                    V.removeChildren(this._input), V.create(e.each(this._options, function (t) {
                        this.push("option", {value: t, text: t})
                    }, []), this._input)
                }
            },
            color: {
                type: "color", getValue: function (t) {
                    return new D(t)
                }, setValue: function (t) {
        ...
        initialize: function ke(t) {
            this._id = ke._id = (ke._id || 0) + 1, this._type = t.type in this._types ? t.type : "options" in t ? "list" : "onClick" in t ? "button" : typeof t.value, this._meta = this._types[this._type] || {type: this._type};
            var n = this, i = "component-" + this._id;
            this._dontFire = !0, this._input = V.create(this._meta.tag || "input", {
                id: i,
            ...
            }), this._element = V.create("tr", ["td", [this._label = V.create("label", {"for": i})], "td", [this._input]]), e.each(t, function (t, e) {
                this[e] = t
        ...
        getValue: function () {
            var t = this._value, e = this._meta.getValue;
            return e ? e.call(this, t) : t
        },
        setValue: function (t) {
            var e = this._meta.value || "value", n = this._meta.setValue;
            n && (t = n.call(this, t)), V.set(this._input, e, t), t = V.get(this._input, e), this._meta.number && (t = parseFloat(t, 10)), this._value !== t && (this._value = t, this._dontFire || this.fire("change", this.getValue()))
        },
        getRange: function () {
        ...
        setRange: function (t, e) {
            ...
            V.set(this._input, {min: n[0], max: n[1]})
        },
        getMin: function () {
        ...
        canvases: [], getCanvas: function (t, e, n) {
            var i, r = !0;
            "object" == typeof t && (n = e, e = t.height, t = t.width), n ? 1 !== n && (t *= n, e *= n) : n = 1, i = this.canvases.length ? this.canvases.pop() : document.createElement("canvas");
            var s = i.getContext("2d");
            return i.width === t && i.height === e ? r && s.clearRect(0, 0, t + 1, e + 1) : (i.width = t, i.height = e), s.save(), 1 !== n && s.scale(n, n), i
    ...
    }, {}), ne = {href: "http://www.w3.org/1999/xlink", xlink: "http://www.w3.org/2000/xmlns"};
    return new function () {
        function t(t, e) {
            for (var n in e) {
                var i = e[n], r = ne[n];
        ...
        function r(t, e, n) {
            var i = t._matrix, r = i.getTranslation(), s = {};
            if (e) {
                i = i.shiftless();
                var a = i._inverseTransform(r);
                s[n ? "cx" : "x"] = a.x, s[n ? "cy" : "y"] = a.y, r = null
            }
            if (!i.isIdentity()) {
                var h = i.decompose();
                if (h && !h.shearing) {
                    var u = [], l = h.rotation, c = h.scaling;
                    r && !r.isZero() && u.push("translate(" + S.point(r) + ")"), l && u.push("rotate(" + S.number(l) + ")"), o.isZero(c.x - 1) && o.isZero(c.y - 1) || u.push("scale(" + S.point(c) + ")"), s.transform = u.join(" ")
        ...
        function s(e, i) {
            for (var s = r(e), a = e._children, o = n("g", s), h = 0, u = a.length; u > h; h++) {
                ...
                if (c) if (l.isClipMask()) {
                    var d = n("clipPath");
                    d.appendChild(c), w(l, d, "clip"), t(o, {"clip-path": "url(#" + d.id + ")"})
        ...
        function u(t, e) {
            ...
            if (t.isPolygon()) if (o.length >= 3) {
                ...
                s = "line";
                var u = o[0]._point, d = o[o.length - 1]._point;
                a = {x1: u.x, y1: u.y, x2: d.x, y2: d.y}
            } else {
                s = "path";
                var f = t.getPathData();
                a = f && {d: f}
        ...
        function c(t) {
            var e = t._type, i = t._radius, s = r(t, !0, "rectangle" !== e);
            if ("rectangle" === e) {
                e = "rect";
        ...
        function d(t) {
            var e = r(t, !0), i = t.getPathData();
            return i && (e.d = i), n("path", e)
        }

        function f(t, e) {
            var i = r(t, !0), s = t.getSymbol(), a = m(s, "symbol"), o = s.getDefinition(), h = o.getBounds();
            return a || (a = n("symbol", {viewBox: S.rectangle(h)}), a.appendChild(b(o, e)), w(s, a, "symbol")), i.href = "#" + a.id, i.x += h.x, i.y += h.y, i.width = S.number(h.width), i.height = S.number(h.height), n("use", i)
        }

        function _(t) {
            var e = m(t, "color");
            if (!e) {
                var i, r = t.getGradient(), s = r._radial, a = t.getOrigin().transform(),
        ...
        function p(n, i) {
            var r = {}, s = n.getParent();
            return null != n._name && (r.id = n._name), e.each(ee, function (t) {
                var i = t.get, a = t.type, o = n[i]();
                if (!s || !e.equals(s[i](), o)) {
                    if ("color" === a && null != o) {
                        var h = o.getAlpha();
            ...
            }), 1 === r.opacity && delete r.opacity, null == n._visibility || n._visibility || (r.visibility = "hidden"), t(i, r)
        }
        ...
        var S, P,
            k = {Group: s, Layer: s, Raster: h, Path: u, Shape: c, CompoundPath: d, PlacedSymbol: f, PointText: g};
        y.inject({
            exportSVG: function (t) {
                return t = C(t), x(b(this, t), t)
            }
        }), v.inject({
            exportSVG: function (t) {
                t = C(t);
        ...
        function n(t, e, n, i) {
            var r = ne[e], s = r ? t.getAttributeNS(r, e) : t.getAttribute(e);
        ...
        function a(t, e, n, i) {
            var r = t.childNodes, s = "clippath" === e, a = new w, o = a._project, h = o._currentStyle, u = [];
        ...
        function l(t, e) {
            ...
            var d, f, _;
            return a ? (d = i(t, "cx", "cy"), f = d.add(n(t, "r"), 0), _ = i(t, "fx", "fy", !0)) : (d = i(t, "x1", "y1"), f = i(t, "x2", "y2")), x(new D(r, d, f, _), t), null
        }
        ...
        function P(t, e, n) {
            function i(t) {
                paper = s;
                var i = P(t, e, n), r = n.onLoad, a = s.project && s.getView();
            ...
            var o, h = r.nodeName.toLowerCase(), u = k[h], l = r.getAttribute && r.getAttribute("data-paper-data"),
                c = s.settings, d = c.applyMatrix;
            return c.applyMatrix = !1, o = u && u(r, h, e, n) || null, c.applyMatrix = d, o && (o instanceof w || (o = x(o, r, e)), n.expandShapes && o instanceof b && (o.remove(), o = o.toPath()), l && (o._data = JSON.parse(l))), e && (z = {}), o
        }
        ...
        var k = {
            ...
            ellipse: function (t) {
                return new b.Ellipse({center: i(t, "cx", "cy"), radius: r(t, "rx", "ry")})
            },
            rect: function (t) {
        ...
        function i(t) {
            ...
            function i(n, i) {
                ...
                s.splice(o, 0, [r, i.length - a + r]), t = t.substring(0, r) + i + t.substring(a)
            }
            ...
            function r(t, e) {
                if (t) {
                    for (var s in t) if ("range" !== s) {
                        var a = t[s];
                        if (Array.isArray(a)) for (var o = 0, h = a.length; h > o; o++) r(a[o], t); else a && "object" == typeof a && r(a, t)
                    }
                    switch (t && t.type) {
            ...
            var s = [];
            return r(l.acorn.parse(t, {ranges: !0})), t
        }
        ...
        function s(r, s) {
            ...
            paper = s;
            var o, u = s.getView(), l = /\s+on(?:Key|Mouse)(?:Up|Down|Move|Drag)\b/.test(r) ? new Y : null,
                c = l ? l._events : [], d = ["onFrame", "onResize"].concat(c), f = [], _ = [];
            r = i(r), a({_$_: t, $_: n, view: u, tool: l}, !0), a(s), d = e.each(d, function (t) {
                RegExp("\\s+" + t + "\\b").test(r) && (f.push(t), this.push(t + ": " + t))
            }, []).join(", "), d && (r += "\nreturn { " + d + " };");
            var g = window.InstallTrigger;
            if (g || window.chrome) {
                var p = document.createElement("script"), v = document.head;
                g && (r = "\n" + r), p.appendChild(document.createTextNode("paper._execute = function(" + f + ") {" + r + "\n}")), v.appendChild(p), o = paper._execute, delete paper._execute, v.removeChild(p)
            } else o = Function(f, r);
            var m = o.apply(s, _) || {};
            e.each(c, function (t) {
                var e = m[t];
        ...
        function a() {
            e.each(document.getElementsByTagName("script"), function (t) {
                if (/^text\/(?:x-|)paperscript$/.test(t.type) && !t.getAttribute("data-paper-ignore")) {
                    var e = r.getAttribute(t, "canvas"), n = r.get(e) || new r(t).setup(e), i = t.src;
                    i ? K.request("get", i, function (t) {
                        s(t, n)
                    }) : s(t.innerHTML, n), t.setAttribute("data-paper-ignore", !0)
                }
            }, this)
        }
        ...
        !function (t, e) {
            ...
            function h() {
                for (var t = ve, e = ce.onComment && ce.locations && new r, n = de.charCodeAt(ve += 2); fe > ve && 10 !== n && 13 !== n && 8232 !== n && 8329 !== n;) ++ve, n = de.charCodeAt(ve);
            ...
            function u() {
                for (; fe > ve;) {
                    ...
                    if (32 === t) ++ve; else if (13 === t) {
                    ...
                    } else if (10 === t) ++ve, ++Pe, ke = ve; else if (14 > t && t > 8) ++ve; else if (47 === t) {
                        ...
                        if (!(t >= 5760 && Un.test(String.fromCharCode(t)))) break;
                        ++ve
                    }
                }
            }
            ...
            function S(t) {
                ...
                return i ? o = parseFloat(h) : r && 1 !== h.length ? /[89]/.test(h) || Oe ? n(e, "Invalid number") : o = parseInt(h, 8) : o = parseInt(h, 10), a(Ee, o)
            }
            ...
            function P(t) {
                ...
                for (var e = ""; ;) {
                    ...
                    if (92 === i) {
                        ...
                        if ("0" === r && (r = null), ++ve, r) Oe && n(ve - 2, "Octal literal in strict mode"), e += String.fromCharCode(parseInt(r, 8)), ve += r.length - 1; else switch (i) {
                            case 110:
                                e += "\n";
                                break;
                            case 114:
                    ...
                    } else (13 === i || 10 === i || 8232 === i || 8329 === i) && n(me, "Unterminated string constant"), e += String.fromCharCode(i), ++ve
                }
            }
            ...
            function z() {
                var t = M(), e = De;
                return Rn || (Hn(t) ? e = cn[t] : (ce.forbidReserved && (3 === ce.ecmaVersion ? Fn : Vn)(t) || Oe && qn(t)) && n(me, "The keyword '" + t + "' is reserved")), a(e, t)
            }
            ...
            function L() {
                var t = new T;
                return ce.locations && (t.loc = new O), ce.ranges && (t.range = [me, 0]), t
            }

            function E(t) {
                var e = new T;
                return e.start = t.start, ce.locations && (e.loc = new O, e.loc.start = t.loc.start), ce.ranges && (e.range = [t.range[0], 0]), e
            }

            function N(t, e) {
                return t.type = e, t.end = ze, ce.locations && (t.loc.end = Ie), ce.ranges && (t.range[1] = ze), t
            }
            ...
            function q(t) {
                "Identifier" !== t.type && "MemberExpression" !== t.type && n(t.start, "Assigning to rvalue"), Oe && "Identifier" === t.type && Zn(t.name) && n(t.start, "Assigning to " + t.name + " in strict mode")
            }

            function Z(t) {
                Me = ze = ve, ce.locations && (Ie = new r), Ae = Oe = null, Te = [], y();
                var e = t || L(), n = !0;
                for (t || (e.body = []); be !== Be;) {
                    var i = H();
            ...
            function H() {
                ...
                switch (t) {
                    ...
                    case qe:
                        ...
                        return r === Te.length && n(e.start, "Unsyntactic " + t.keyword), N(e, i ? "BreakStatement" : "ContinueStatement");
                    case Ze:
                        return I(), R(), N(e, "DebuggerStatement");
                    case Ue:
                        return I(), Te.push(ti), e.body = H(), Te.pop(), F(nn), e.test = U(), R(), N(e, "DoWhileStatement");
                    case $e:
                        if (I(), Te.push(ti), F(pn), be === yn) return G(e, null);
                        if (be === en) {
                            var a = L();
                            return I(), X(a, !0), 1 === a.declarations.length && D(ln) ? $(e, a) : G(e, a)
                        }
                        var a = J(!1, !0);
                    ...
                    case Xe:
                        return I(), he(e, !0);
                    case Je:
                        return I(), e.test = U(), e.consequent = H(), e.alternate = D(We) ? H() : null, N(e, "IfStatement");
                    case Ye:
                        return Ae || n(me, "'return' outside of function"), I(), D(yn) || B() ? e.argument = null : (e.argument = J(), R()), N(e, "ReturnStatement");
                    case Ke:
                        I(), e.discriminant = U(), e.cases = [], F(_n), Te.push(ei);
                        for (var o, h; be != gn;) if (be === Fe || be === He) {
                            var u = be === Fe;
                            o && N(o, "SwitchCase"), e.cases.push(o = L()), o.consequent = [], I(), u ? o.test = J() : (h && n(Me, "Multiple default clauses"), h = !0, o.test = null), F(wn)
                        } else o || V(), o.consequent.push(H());
                        return o && N(o, "SwitchCase"), I(), Te.pop(), N(e, "SwitchStatement");
                    case Qe:
                        return I(), Jn.test(de.slice(ze, me)) && n(ze, "Illegal newline after throw"), e.argument = J(), R(), N(e, "ThrowStatement");
                    case tn:
                        if (I(), e.block = W(), e.handler = null, be === Ve) {
                            var l = L();
                            I(), F(pn), l.param = le(), Oe && Zn(l.param.name) && n(l.param.start, "Binding " + l.param.name + " in strict mode"), F(vn), l.guard = null, l.body = W(), e.handler = N(l, "CatchClause")
                        }
                        return e.guardedHandlers = Le, e.finalizer = D(Ge) ? W() : null, e.handler || e.finalizer || n(e.start, "Missing catch or finally clause"), N(e, "TryStatement");
                    case en:
                        return I(), e = X(e), R(), e;
                    case nn:
                        return I(), e.test = U(), Te.push(ti), e.body = H(), Te.pop(), N(e, "WhileStatement");
                    case rn:
                        return Oe && n(me, "'with' in strict mode"), I(), e.object = U(), e.body = H(), N(e, "WithStatement");
                    case _n:
                        return W();
                    case yn:
                    ...
                    default:
                        ...
                        if (t === De && "Identifier" === d.type && D(wn)) {
                            ...
                            return Te.push({
                                name: c,
                                kind: f
                            }), e.body = H(), Te.pop(), e.label = d, N(e, "LabeledStatement")
                        }
            ...
            function G(t, e) {
                return t.init = e, F(yn), t.test = be === yn ? null : J(), F(yn), t.update = be === vn ? null : J(), F(vn), t.body = H(), Te.pop(), N(t, "ForStatement")
            }
            ...
            function Y(t) {
                ...
                if (be.isAssign) {
                    var n = E(e);
                    return n.operator = Ce, n.left = e, I(), n.right = Y(t), q(e), N(n, "AssignmentExpression")
                }
                return e
            }
            ...
            function te(t, e, n) {
                ...
                if (null != i && (!n || be !== ln) && i > e) {
                    var r = E(t);
                    r.left = t, r.operator = Ce, I(), r.right = te(ee(), i, n);
            ...
            function ee() {
                if (be.prefix) {
                    ...
                    return t.operator = Ce, t.prefix = !0, I(), t.argument = ee(), e ? q(t.argument) : Oe && "delete" === t.operator && "Identifier" === t.argument.type && n(t.start, "Deleting local variable in strict mode"), N(t, e ? "UpdateExpression" : "UnaryExpression")
                }
                for (var i = ne(); be.postfix && !B();) {
                    var t = E(i);
                    t.operator = Ce, t.prefix = !1, t.argument = i, q(i), I(), i = N(t, "UpdateExpression")
                }
                return i
            }
            ...
            function re() {
                switch (be) {
                    ...
                    case Ne:
                        var t = L();
                        return t.value = Ce, t.raw = de.slice(me, ye), I(), N(t, "Literal");
                    case on:
                    case hn:
                    case un:
                        var t = L();
                        return t.value = be.atomValue, t.raw = be.keyword, I(), N(t, "Literal");
                    case pn:
                        var e = we, n = me;
                        I();
                        var i = J();
                    ...
                    case dn:
                        var t = L();
                        return I(), t.elements = ue(fn, !0, !0), N(t, "ArrayExpression");
                    case _n:
                        return ae();
                    case Xe:
                        var t = L();
            ...
            function se() {
                var t = L();
                return I(), t.callee = ie(re(), !0), t.arguments = D(pn) ? ue(vn, !1) : Le, N(t, "NewExpression")
            }

            function ae() {
                var t = L(), e = !0, i = !1;
                for (t.properties = [], I(); !D(gn);) {
                    if (e) e = !1; else if (F(mn), ce.allowTrailingCommas && D(gn)) break;
                    var r, s = {key: oe()}, a = !1;
                    if (D(wn) ? (s.value = J(!0), r = s.kind = "init") : ce.ecmaVersion >= 5 && "Identifier" === s.key.type && ("get" === s.key.name || "set" === s.key.name) ? (a = i = !0, r = s.kind = s.key.name, s.key = oe(), be !== pn && V(), s.value = he(L(), !1)) : V(), "Identifier" === s.key.type && (Oe || i)) for (var o = 0; o < t.properties.length; ++o) {
                        ...
                        if (h.key.name === s.key.name) {
                            ...
                            u && !Oe && "init" === r && "init" === h.kind && (u = !1), u && n(s.key.start, "Redefinition of property")
                        }
                    }
                    t.properties.push(s)
                }
            ...
            function he(t, e) {
                be === De ? t.id = le() : e ? V() : t.id = null, t.params = [];
                var i = !0;
                for (F(pn); !D(vn);) i ? i = !1 : F(mn), t.params.push(le());
                var r = Ae, s = Te;
            ...
            function ue(t, e, n) {
                for (var i = [], r = !0; !D(t);) {
                    if (r) r = !1; else if (F(mn), e && ce.allowTrailingCommas && D(t)) break;
            ...
            function le(t) {
                var e = L();
                return e.name = be === De ? Ce : t && !ce.forbidReserved && be.keyword || V(), I(), N(e, "Identifier")
            }
            ...
            var ve, me, ye, we, xe, be, Ce, Se, Pe, ke, Me, ze, Ie, Ae, Te, Oe, Le = [], Ee = {type: "num"},
                Ne = {type: "regexp"}, je = {type: "string"}, De = {type: "name"}, Be = {type: "eof"},
                Re = {keyword: "break"}, Fe = {keyword: "case", beforeExpr: !0}, Ve = {keyword: "catch"},
                qe = {keyword: "continue"}, Ze = {keyword: "debugger"}, He = {keyword: "default"},
                Ue = {keyword: "do", isLoop: !0}, We = {keyword: "else", beforeExpr: !0}, Ge = {keyword: "finally"},
                $e = {keyword: "for", isLoop: !0}, Xe = {keyword: "function"}, Je = {keyword: "if"},
                Ye = {keyword: "return", beforeExpr: !0}, Ke = {keyword: "switch"},
                Qe = {keyword: "throw", beforeExpr: !0}, tn = {keyword: "try"}, en = {keyword: "var"},
                nn = {keyword: "while", isLoop: !0}, rn = {keyword: "with"}, sn = {keyword: "new", beforeExpr: !0},
                an = {keyword: "this"}, on = {keyword: "null", atomValue: null}, hn = {keyword: "true", atomValue: !0},
                un = {keyword: "false", atomValue: !1}, ln = {keyword: "in", binop: 7, beforeExpr: !0}, cn = {
                    "break": Re,
                    "case": Fe,
                    "catch": Ve,
                    "continue": qe,
                ...
                }, dn = {type: "[", beforeExpr: !0}, fn = {type: "]"}, _n = {type: "{", beforeExpr: !0}, gn = {type: "}"},
                pn = {type: "(", beforeExpr: !0}, vn = {type: ")"}, mn = {type: ",", beforeExpr: !0},
                yn = {type: ";", beforeExpr: !0}, wn = {type: ":", beforeExpr: !0}, xn = {type: "."},
                bn = {type: "?", beforeExpr: !0}, Cn = {binop: 10, beforeExpr: !0}, Sn = {isAssign: !0, beforeExpr: !0},
                Pn = {isAssign: !0, beforeExpr: !0}, kn = {binop: 9, prefix: !0, beforeExpr: !0},
                Mn = {postfix: !0, prefix: !0, isUpdate: !0}, zn = {prefix: !0, beforeExpr: !0},
                In = {binop: 1, beforeExpr: !0}, An = {binop: 2, beforeExpr: !0}, Tn = {binop: 3, beforeExpr: !0},
                On = {binop: 4, beforeExpr: !0}, Ln = {binop: 5, beforeExpr: !0}, En = {binop: 6, beforeExpr: !0},
                Nn = {binop: 7, beforeExpr: !0}, jn = {binop: 8, beforeExpr: !0}, Dn = {binop: 10, beforeExpr: !0};
            t.tokTypes = {
                bracketL: dn,
                bracketR: fn,
                braceL: _n,
            ...
            var Rn,
                ...
                $n = RegExp("[" + Wn + "]"), Xn = RegExp("[" + Wn + Gn + "]"), Jn = /[\n\r\u2028\u2029]/,
        ...
        var d = {
            ...
            _ = e.each(["add", "subtract", "multiply", "divide", "modulo", "negate"], function (t) {
                this["__" + t] = "#" + t
            }, {});
        return h.inject(_), c.inject(_), D.inject(_), "complete" === document.readyState ? setTimeout(a) : q.add(window, {load: a}), {
            compile: i,
            execute: s,
            load: a,
            lineNumberBase: 0
